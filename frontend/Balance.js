...
//   const [user, setUser] = useState(null); // Initialize user as null to handle loading state
...
//       {/* You can use the loading state to show a spinner or some other UI while loading */}
//       {loading ? (
//         <ActivityIndicator size="large" color="#0000ff" />
//       ) : (
//         <>
//           {/* Display user balance or other data here */}
//           {/* Example */}
//           <Text>User Balance: {user?.balance}</Text>
//         </>
//       )}
